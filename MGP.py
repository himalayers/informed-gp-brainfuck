...
import random, BFGeneratorForWords, BFAST2, GP, pprint, copy, IGP, EDA
...
def run(INPUTS, TARGETS, FITNESSEVALS, MAXPROGSIZE, verbose=-1):
    ...
    for n in range(GENNO):
        outputs = [(popset, GP.run(*base, *popset, verbose=-1)) for popset in population]
